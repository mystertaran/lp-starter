      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
        <div className="max-w-4xl">
          ...
          <h2 className="text-display-lg font-display text-foreground uppercase">
            Nie kolejna integracja. <span className="text-accent">Architektura.</span>
          </h2>
        ...
        <div className="mt-16 grid gap-x-10 gap-y-10 md:grid-cols-2 lg:grid-cols-3 lg:gap-y-14">
          {MODULES.map((mod, i) => (
