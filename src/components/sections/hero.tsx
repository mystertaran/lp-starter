...
export function Hero() {
  return (
    <section className="border-border relative overflow-hidden border-b">
      <div className="mx-auto grid max-w-7xl gap-8 px-6 py-14 md:gap-12 md:py-20 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:gap-16 lg:px-10 lg:py-28">
        <div className="flex flex-col justify-center">
          <p className="text-muted-foreground mb-5 font-sans text-sm font-semibold tracking-[0.14em] uppercase">
            {SITE.product} · {SITE.tagline.split(".")[0]}
          </p>
          <h1 className="text-display-xl font-display text-foreground uppercase">
            Jedno miejsce dla wszystkiego, co robi Twój zespół.
          </h1>
          <p className="text-muted-foreground mt-7 max-w-xl font-sans text-lg leading-relaxed md:text-xl">
            Zamiast kolejnego narzędzia — jedno źródło prawdy. {SITE.product} łączy procesy,
            integracje i ludzi w jeden płynny przebieg.
          </p>
